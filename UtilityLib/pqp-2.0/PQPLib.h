...
enum MY_DETECTION_TYPE{COLLIDE_ONLY, NEAREST_DIST};
...
struct Manager{
    ...
    std::vector<IntersectResult> testIntersection( MY_DETECTION_TYPE type, size_t model_id1 = 0, size_t model_id2 = 1, PQP_REAL threshold = 1e-12 )
    {
	...
	double getDistance(size_t model_id1 = 0, size_t model_id2 = 1, PQP_REAL threshold = 1e-12)
	{
		PQP_Model & m1 = models[model_id1];
		PQP_Model & m2 = models[model_id2];
