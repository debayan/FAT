...
void hungarian_init(hungarian_t* prob, int* r, size_t m, size_t n, int mode)
{
  ...
  prob->m = m;
  prob->n = n;
  prob->r = (int**)calloc(m,sizeof(int*));
  prob->q = (int**)calloc(m,sizeof(int*));
  prob->mode = mode;
  prob->maxutil = 0;
  for(i=0;i<m;i++)
  {
    prob->r[i] = (int*)calloc(n,sizeof(int));
  ...
  prob->a = (int*)calloc(m,sizeof(int));
  prob->u = (int*)calloc(m,sizeof(int));
  prob->v = (int*)calloc(n,sizeof(int));
  prob->seq.i = (int*)calloc(m*n,sizeof(int));
  prob->seq.j = (int*)calloc(m*n,sizeof(int));
  prob->ess_rows = (int*)calloc(m,sizeof(int));
  prob->ess_cols = (int*)calloc(n,sizeof(int));
}
...
void hungarian_make_cover(hungarian_t* prob)
{
  ...
  assert(prob);
  row_max = (int*)calloc(prob->m,sizeof(int));
  col_max = (int*)calloc(prob->n,sizeof(int));
